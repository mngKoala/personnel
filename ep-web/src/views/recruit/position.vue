<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="招聘需求" prop="content" />
      <el-table-column align="center" label="备注" prop="notes" />
      <el-table-column align="center" label="创建时间" prop="createTime" />
      <el-table-column align="center" label="操作" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['POST /post/rec/update']" type="primary" size="mini" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button v-permission="['POST /post/rec/delete']" type="danger" size="mini" @click="handleDelete(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { listRecruitPostRec, createRecruitPostRec, updateRecruitPostRec, deleteRecruitPostRec } from '@/api/recruit'
...
export default {
  ...
  methods: {
    getList() {
      ...
      listRecruitPostRec(this.listQuery)
        .then(response => {
    ...
    createData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          createRecruitPostRec(this.dataForm)
            .then(response => {
    ...
    updateData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          updateRecruitPostRec(this.dataForm)
            .then(() => {
