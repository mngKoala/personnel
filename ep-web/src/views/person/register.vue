  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="员工">
        <template slot-scope="scope">
          <span v-if="scope.row.hrmEmployee != null">{{ scope.row.hrmEmployee.hrmPerson.name }}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="操作" class-name="small-padding fixed-width" width="220">
        <template slot-scope="scope">
          <el-button v-permission="['POST /admin/admin/update']" type="primary" size="mini" @click="handleDetail(scope.row)">查看</el-button>
...
<script>
import { listPerson, listEmployee, createPerson, updatePerson, deletePerson, readPerson } from '@/api/register'
  ...
  data() {
    return {
      ...
      dataForm: {
        ...
        sexCode: undefined,
        birthday: undefined,
        nativePlaceCode: undefined,
        nationCode: undefined,
        maritalStatus: undefined,
        employeeStatus: undefined,
        employeeIdentityStatus: undefined,
        employeeTypeCode: undefined,
        ...
        politicCountenanceCode: undefined,
        joinPartDate: undefined,
        bloodType: undefined,
        bodyHeight: undefined,
        bodyWeight: undefined,
        employmentDate: undefined,
        employmentConfirmDate: undefined,
        firstEmploymentDate: undefined,
        firstWorkDate: undefined,
        orgId: undefined,
        positionCode: undefined,
        employeeTitleCode: undefined,
        rankCode: undefined,
        workKindCode: undefined,
        leaveDate: undefined,
        leaveReson: undefined,
        payrollCardBankCode: undefined,
        payrollCard: undefined,
        salaryTplId: undefined,
        salaryPayOut: undefined,
        salaryNotes: undefined,
        personPictureId: undefined,
      ...
      rules: {
        ...
        employeeIdentityStatus: [
          { required: true, message: '员工标记不能为空', trigger: 'blur' }
        ],
        salaryPayOut: [
