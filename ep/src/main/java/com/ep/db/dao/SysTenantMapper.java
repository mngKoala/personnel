...
public interface SysTenantMapper {
     ...
     * @mbg.generated
     */
    SysTenant selectByPrimaryKeySelective(@Param("id") String id, @Param("selective") SysTenant.Column ... selective);
     ...
     * @mbg.generated
     */
    SysTenant selectByPrimaryKeyWithLogicalDelete(@Param("id") String id, @Param("andLogicalDeleted") boolean andLogicalDeleted);
