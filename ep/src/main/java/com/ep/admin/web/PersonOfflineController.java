...
@RestController
@RequestMapping("/admin/person/offline")
@Validated
public class PersonOfflineController {
    private final Log logger = LogFactory.getLog(PersonOfflineController.class);

    @Autowired
    private PersonOfflineService personOfflineService;
    ...
    public Object list(String name,
        ...
        List<HrPerson> hrPersonList = personOfflineService.querySelective(name,  page, limit, sort, order);
